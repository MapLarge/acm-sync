...
KIND_CLUSTER ?= acm-sync-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name acm-sync-builder
	$(CONTAINER_TOOL) buildx use acm-sync-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm acm-sync-builder
	rm Dockerfile.cross
